<%@ Page Title="Tops - Fashion Merchandising Hub" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Dresses.aspx.cs" Inherits="SwetaGupta_FinalProject.Dresses" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="body" runat="server">
      ...
      <div id="main" class="wrapper style1">
				<section class="container ">
					<header class="major">
						<h2>TOPS</h2>
						<span class="byline">From Casual To Formals <i class="fa fa-heart"></i></span> 
					</header>
                </section>
          ...
          <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
              ...
              <SelectParameters>
                  <asp:Parameter DefaultValue="2" Name="category_id" Type="Int32" />
              </SelectParameters>
                </asp:SqlDataSource>
